...
# assert (first_frame.error.error_code == "ErrorCodes.SUCCESS"), first_frame;
# assert(second_frame.error.error_code == "ErrorCodes.SUCCESS"), first_frame;
